...
SERVICE_FILE="$PROJECT_DIR/raspberry_pi/service/museum-service.service"
...
echo "  Logs:    tail -f ~/Documents/GitHub/museum-system/raspberry_pi/logs/museum.log"
echo "  Watchdog Status: sudo systemctl status $WATCHDOG_NAME"
echo "  Watchdog Logs:   tail -f ~/Documents/GitHub/museum-system/raspberry_pi/logs/watchdog-info.log"
echo ""
echo "🚀 To start now:"
