...
- Local scene START trigger button on `DI5 / GPIO8`.
...
Local DI5 scene trigger publishes:
...
- The local DI5 scene trigger uses active-low input, 100 ms debounce, and a
  non-blocking 4000 ms cooldown to prevent repeated START spam.
