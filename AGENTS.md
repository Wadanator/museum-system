...
- **At end of every session**: update `~/.Codex/projects/C--Users-Wajdy-Documents-Kodovanie-museum-system/memory/project_state.md` with what was done and what's next, so the next session picks up instantly.
